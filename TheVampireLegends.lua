...
do
    ...
    addUiElement("toggles", main:CreateToggle({
    ...
    addUiElement("sliders", main:CreateSlider({
        Name = "Hitbox Size",
        Range = { 0, 30 },
        Increment = 0.5,
        Suffix = "studs",
...
do
    ...
    addUiElement("dropdowns", main:CreateDropdown({
...
do
    ...
    addUiElement("buttons", main:CreateKeybind({
        Name = "Auto Steal",
        CurrentKeybind = "J",
    ...
    addUiElement("buttons", main:CreateButton({
...
do
    ...
    local viewTargetInput = addUiElement("buttons", main:CreateInput({
        Name = "View Player",
        CurrentValue = "",
    ...
    addUiElement("buttons", main:CreateButton({
        ...
        Callback = function()
            ...
            for _, toggle in ipairs(tvlGuiElements.toggles) do
                if toggle and toggle.CurrentValue == true then
                    pcall(function()
                        toggle:Set(false)
                        count = count + 1
                    end)
            ...
            notify("Settings", "Turned off " .. tostring(count) .. " exploits")
        end,
    }))
